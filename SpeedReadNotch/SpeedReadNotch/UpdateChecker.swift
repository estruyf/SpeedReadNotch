...
//  SpeedReadNotch
//
//  Created by Elio Struyf on 11.02.2026.
//
...
class UpdateChecker {
    ...
    private let repoOwner = "estruyf"
    private let repoName = "SpeedReadNotch"
    ...
    private func showUpdateAvailable(latestVersion: String, releaseURL: String) {
        ...
        alert.informativeText = "SpeedReadNotch \(latestVersion) is available. You are currently running \(currentVersion)."
    ...
    private func showUpToDate() {
        ...
        alert.informativeText = "SpeedReadNotch \(currentVersion) is the latest version."
        alert.alertStyle = .informational
